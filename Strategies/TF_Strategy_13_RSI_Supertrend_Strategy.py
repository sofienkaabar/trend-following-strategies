...
def signal(Data, close, super_trend_col, rsi_col, buy, sell):
...
my_data = atr(my_data, 10, 1, 2, 3, 4, genre = 'Smoothed')
my_data = supertrend(my_data, multiplier, 4, 3, 1, 2, 5)
my_data = rsi(my_data, lookback_rsi, 3, 6)
