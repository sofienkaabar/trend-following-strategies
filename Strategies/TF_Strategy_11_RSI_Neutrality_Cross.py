...
def signal(Data, rsi_col, confirmation, buy, sell):
    
    Data = adder(Data, 10)
        
    for i in range(len(Data)):
            
        if Data[i, rsi_col] > 50 + confirmation and \
           Data[i - 1, rsi_col] > 50 and \
           Data[i - 2, rsi_col] < 50 and \
           Data[i - 3, rsi_col] < 50 and \
           Data[i - 4, rsi_col] < 50:
               
               Data[i, buy] = 1
            
        elif Data[i, rsi_col] < 50 - confirmation and \
           Data[i - 1, rsi_col] < 50 and \
           Data[i - 2, rsi_col] > 50 and \
           Data[i - 3, rsi_col] > 50 and \
           Data[i - 4, rsi_col] > 50:
...
my_data = signal(my_data, 4, confirmation, 6, 7)
